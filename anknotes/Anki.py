...
class Anki:
    ...
    def insert_toc_into_see_also(self):
        ...
        log.add('           <h1>INSERT TOC LINKS INTO ANKI NOTES: %d TOTAL NOTES</h1> <HR><BR><BR>' % max_count,
                'see_also', timestamp=False, clear=True,
                extension='htm')
                ...
                if new_toc_count > 0:
                    ...
                    if flat_links:
                        ...
                        if see_also_toc_headers['ul'] in see_also_html:
                            ...
                            see_also_html = see_also_html.replace(see_also_toc_headers['ul'],
