...
class SETTINGS:
    class EVERNOTE:
        class QUERY:
            KEY_BASE = 'anknotesEvernoteQuery'
            TAGS_DEFAULT_VALUE = "#Anki_Import"
            TAGS = KEY_BASE + 'Tags'
            USE_TAGS = KEY_BASE + 'UseTags'
            EXCLUDED_TAGS = KEY_BASE + 'ExcludedTags'
            USE_EXCLUDED_TAGS = KEY_BASE + 'UseExcludedTags'
            LAST_UPDATED_VALUE_RELATIVE = KEY_BASE + 'LastUpdatedValueRelative'
            LAST_UPDATED_VALUE_ABSOLUTE_DATE = KEY_BASE + 'LastUpdatedValueAbsoluteDate'
            LAST_UPDATED_VALUE_ABSOLUTE_TIME = KEY_BASE + 'LastUpdatedValueAbsoluteDateTime'
            LAST_UPDATED_TYPE = KEY_BASE + 'LastUpdatedType'
            USE_LAST_UPDATED = KEY_BASE + 'UseLastUpdated'
            NOTEBOOK = KEY_BASE + 'Notebook'
            NOTEBOOK_DEFAULT_VALUE = 'My Anki Notebook'
            USE_NOTEBOOK = KEY_BASE + 'UseNotebook'
            NOTE_TITLE = KEY_BASE + 'NoteTitle'
            USE_NOTE_TITLE = KEY_BASE + 'UseNoteTitle'
            SEARCH_TERMS = KEY_BASE + 'SearchTerms'
            USE_SEARCH_TERMS = KEY_BASE + 'UseSearchTerms'
            ANY = KEY_BASE + 'Any'
