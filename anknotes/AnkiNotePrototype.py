...
class AnkiNotePrototype:
    ...
    def process_note_content(self):
        ...
        def step_2_modify_image_links():
            ...
            self.Fields[FIELDS.CONTENT] = re.sub(r'<a href="%s".*?>(?P<Title>.+?)</a>' % dropbox_image_url_regex,
            ...
            try:
                ...
                self.Fields[FIELDS.CONTENT] = re.sub(dropbox_image_url_regex, dropbox_image_src_subst % "From Plain-Text Link", self.Fields[FIELDS.CONTENT])
            except:
        ...
        def step_3_occlude_text():
            ...
            self.Fields[FIELDS.CONTENT] = re.sub(r'&lt;&lt;(.+?)&gt;&gt;', r'&lt;&lt;<span class="occluded">$1</span>&gt;&gt;', self.Fields[FIELDS.CONTENT])
    ...
    def update_note(self): 
        ...
        assert self.Fields[FIELDS.CONTENT] == self.Fields[FIELDS.CONTENT]        
